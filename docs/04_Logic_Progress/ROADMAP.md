...
- **작성일**: 2026-03-31
- **최종 수정일**: 2026-06-01 (한화손보 실손 blocker DB 적용)
...
| 6 | 보험상품 확장 | 남은 non-approved source의 문서 hash, 매칭 키워드, caveat 정리 | 한화손보 실손 blocker DB 적용 완료. 남은 raw blocker 1건 처리 |
