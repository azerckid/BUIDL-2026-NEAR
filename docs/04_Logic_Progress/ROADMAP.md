...
- **작성일**: 2026-03-31
- **최종 수정일**: 2026-05-31 (신한라이프 해약환급금 미지급형 추천 snapshot seed 준비)
...
| 7 | 추천 snapshot 확대 | 새 source를 `approved`로 승격하고 `insurance_products` snapshot 발행 | 신한라이프 1건 seed 준비 완료. apply 후 운영 active 추천 10건 |
