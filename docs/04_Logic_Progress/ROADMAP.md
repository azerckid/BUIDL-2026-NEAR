...
- **작성일**: 2026-03-31
- **최종 수정일**: 2026-05-28 (보험사 공시 API adapter 보강)
...
| 트랙 | 핵심 질문 | 다음 작업 |
|---|---|---|
| 실제 보험상품 카탈로그 | 실제 판매 상품을 어떤 공식 출처로 검증하고 주기적으로 갱신할 것인가 | KB손보 문서 다운로드 adapter, 실제 seed 후보 승격 준비 |
