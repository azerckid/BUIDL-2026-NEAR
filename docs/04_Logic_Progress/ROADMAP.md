...
- **작성일**: 2026-03-31
- **최종 수정일**: 2026-05-28 (조건별 보험료 quote matrix 정책 반영)
...
| 트랙 | 핵심 질문 | 다음 작업 |
|---|---|---|
| 실제 보험상품 카탈로그 | 실제 판매 상품과 조건별 보험료를 어떤 공식 출처로 검증하고 주기적으로 갱신할 것인가 | source-aware seed 후보 승격 정책 확정, 대표 보험료 caveat 반영, quote matrix PoC 준비 |
