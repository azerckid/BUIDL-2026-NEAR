...
- **작성일**: 2026-03-31
- **최종 수정일**: 2026-05-30 (첫 source-backed 추천 snapshot DB 적용)
...
| 트랙 | 핵심 질문 | 다음 작업 |
|---|---|---|
| 실제 보험상품 카탈로그 | 실제 판매 상품과 조건별 보험료를 어떤 공식 출처로 검증하고 주기적으로 갱신할 것인가 | 추천 카드에서 대표 보험료와 조건별 approved quote matrix를 분리 표시. 기존 demo 상품 노출 정책 결정 |
