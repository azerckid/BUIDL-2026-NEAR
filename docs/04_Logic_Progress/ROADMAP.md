...
- **작성일**: 2026-03-31
- **최종 수정일**: 2026-05-30 (KDB source document seed 후보 추가)
...
| 트랙 | 핵심 질문 | 다음 작업 |
|---|---|---|
| 실제 보험상품 카탈로그 | 실제 판매 상품과 조건별 보험료를 어떤 공식 출처로 검증하고 주기적으로 갱신할 것인가 | KDB 2개 문서 운영 DB 적용, 신한라이프 일반형 공식 문서 endpoint 탐색, raw/needs_review 매칭 키워드 정리 |
