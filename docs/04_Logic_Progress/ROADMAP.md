...
- **작성일**: 2026-03-31
- **최종 수정일**: 2026-06-01 (미래에셋생명 DB apply)
...
| 7 | 추천 snapshot 확대 | 새 source를 `approved`로 승격하고 `insurance_products` snapshot 발행 | 미래에셋생명까지 DB apply 완료. 운영 active 추천 15건 |
