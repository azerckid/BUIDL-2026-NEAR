...
- **작성일**: 2026-03-31
- **최종 수정일**: 2026-05-31 (삼성화재 실손 문서 blocker 해소)
...
| 7 | 추천 snapshot 확대 | 새 source를 `approved`로 승격하고 `insurance_products` snapshot 발행 | 실손 baseline 3건 DB apply 및 남성 quote approval 적용 완료. 삼성화재 1건 seed PR 대기 |
