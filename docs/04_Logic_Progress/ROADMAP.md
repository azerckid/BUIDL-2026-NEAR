...
- **작성일**: 2026-03-31
- **최종 수정일**: 2026-05-30 (신한라이프 일반형 endpoint 탐색)
...
| 트랙 | 핵심 질문 | 다음 작업 |
|---|---|---|
| 실제 보험상품 카탈로그 | 실제 판매 상품과 조건별 보험료를 어떤 공식 출처로 검증하고 주기적으로 갱신할 것인가 | KDB/한화생명/교보라이프플래닛 후보의 매칭 키워드와 caveat 정리, 첫 추천 snapshot 발행 PR 준비 |
