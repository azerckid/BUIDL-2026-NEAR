...
- **결론**: 공시실 페이지 접근과 보수적 상품명 매칭은 가능하다. v1.2에서 KB손보 다이렉트 모바일 `glCommonCode`의 `Medical_Self` 약관 경로를 추가해 PDF hash 확보 문서가 9개에서 10개로 증가했다. 남은 대표 상품 공백은 DB생명의 상품명 매칭이다.
...
| 공시실 페이지 접근 | 7개 성공 |
| PDF hash 확보 | 10개 |
| hash 확보 상품 | 삼성생명 인터넷 입원 건강보험 통합약관, 삼성화재 다이렉트 실손의료비보험 약관, DB손보 다이렉트 실손의료비보험 약관/사업방법서/상품요약서, 현대해상 다이렉트실손의료비보장보험 약관, KB손보 다이렉트실손의료비보장보험 약관, 신한SOL암보험 상품요약서/사업방법서/판매약관 |
...
| KB손보 약관 | `https://m.kbinsure.co.kr:8547/dctapp/views/terms/KB_Direct_Medical(25192)_202605.pdf` | `4c5927fb929cae39c4f5a4957945a75e208769a6d7c46d7e892c2942ffe8e98a` |
...
| KB손보 | `hashed` | 다이렉트 모바일 `glCommonCode`의 `Medical_Self` 약관 파일명에서 PDF hash 확보 |
...
- **Data**: [Latest Carrier Disclosure Probe](../../data/insurance/latest_carrier_disclosure_probe.json) - 공시실 crawler v1.2 실행 결과
