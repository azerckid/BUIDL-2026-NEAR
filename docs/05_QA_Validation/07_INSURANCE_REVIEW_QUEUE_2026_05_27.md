...
1. 위 7개 hash-backed row의 수동 검수 결과를 갱신한다.
...
4. 신한라이프, KB손보, 현대해상, 삼성생명 hash-backed row는 판매상태, 보험료 산정 기준, 보장 카테고리, risk_targets를 먼저 검수한다.
...
- **QA_Validation**: [Hash-backed Product Manual Review](./08_HASH_BACKED_PRODUCT_MANUAL_REVIEW_2026_05_27.md) - v1 수동 검수 결과와 v1.2 추가 검수 대기 목록
